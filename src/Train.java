...
public class Train {
    ...
    private int stops;                  // total number of stops on the route
    private int madeStops;              // how many stops actually used (where someone entered/exited)
    private int currTime;               // last time unit where something happened
    ...
    public void displayStops() {
        System.out.println("Train made " + madeStops +
